...
class PlaceGroundOverlayPage extends GoogleMapExampleAppPage {
  const PlaceGroundOverlayPage({super.key}) : super(const Icon(Icons.image), 'Ground Overlay');
...
class PlaceGroundOverlayBodyState extends State<PlaceGroundOverlayBody> {
  ...
  Future<void> _createGroundOverlayImageFromAsset(BuildContext context) async {
    if (_bitMapDesc == null) {
      ...
      createLocalImageConfiguration(context, size: Size(2429, 2668));
      await BitmapDescriptor.fromAssetImage(
        imageConfiguration,
        'assets/map-overlay2.png',
      ).then(_updateBitmap);
    }
  }
